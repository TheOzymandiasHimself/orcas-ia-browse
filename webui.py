...
def create_ui(theme_name="Ocean"):
    css = """
    :root {
        --background-fill-primary: rgba(10, 25, 47, 0.7) !important;
        --background-fill-secondary: rgba(17, 34, 64, 0.6) !important;
        --block-background-fill: rgba(16, 33, 65, 0.4) !important;
        --block-title-text-color: rgba(255, 255, 255, 0.95) !important;
        --body-text-color: rgba(255, 255, 255, 0.85) !important;
        --color-accent-soft: rgba(64, 142, 197, 0.7) !important;
        --color-accent: rgba(100, 181, 246, 0.8) !important;
        --input-background-fill: rgba(15, 30, 60, 0.3) !important;
        --table-border-color: rgba(100, 181, 246, 0.2) !important;
    }
    body {
        background: linear-gradient(135deg, #030d1f, #061428) !important;
    }
    .gradio-container {
        ...
        background-color: rgba(16, 33, 65, 0.3) !important;
    }
    .header-text {
        text-align: center;
        margin-bottom: 30px;
    ...
    .header-text h1 {
        ...
        background: linear-gradient(to right, #64b5f6, #ffffff, #64b5f6) !important;
        -webkit-background-clip: text !important;
        background-clip: text !important;
        color: transparent !important;
        animation: glow 3s ease-in-out infinite alternate, float 6s ease-in-out infinite !important;
        text-shadow: 0 0 10px rgba(100, 181, 246, 0.8), 0 0 20px rgba(100, 181, 246, 0.5), 0 0 30px rgba(100, 181, 246, 0.3) !important;
    ...
    @keyframes glow {
        0% { text-shadow: 0 0 10px rgba(100, 181, 246, 0.8), 0 0 20px rgba(100, 181, 246, 0.5), 0 0 30px rgba(100, 181, 246, 0.3); }
        100% { text-shadow: 0 0 15px rgba(100, 181, 246, 0.9), 0 0 25px rgba(100, 181, 246, (0.6), 0 0 35px rgba(100, 181, 246, 0.4); }
    }
    ...
    .theme-section {
        ...
        background-color: rgba(16, 33, 65, 0.4) !important;
        border: 1px solid rgba(100, 181, 246, 0.3) !important;
        box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.37) !important;
    }
    .tabs, .tab-nav {
        background-color: rgba(15, 30, 60, 0.3) !important;
    ...
    button {
        background-color: rgba(64, 142, 197, 0.4) !important;
        border: 1px solid rgba(100, 181, 246, 0.3) !important;
    ...
    button:hover {
        ...
        box-shadow: 0 0 12px rgba(100, 181, 246, 0.5) !important;
        transform: translateY(-2px) !important;
    }
    input, textarea, select {
        background-color: rgba(15, 30, 60, 0.2) !important;
        border: 1px solid rgba(100, 181, 246, 0.2) !important;
    }
    ...
    .popup, .gradio-dropdown, .popup-container {
    ...
    with gr.Blocks(
            title="ORCA's IA BROWSER", theme=theme_map[theme_name], css=css
    ) as demo:
        with gr.Row():
            gr.Markdown(
                """
                # 🐬 ORCA's IA BROWSER
                ### Your personal AI enhanced swiss knife tool box. Explore the web like never before.
                """,
